...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_file_path", type=str,
                        default=data_dir, help="Raw traffic readings.")
    ...
    parser.add_argument("--dataset", default='Metro', type=str, help="configuration file path")
    ...
    # 指定要保存的文件路径
    output_file_path = os.path.join(args.output_dir, "adj_mx.pkl")
    # 使用pickle将列表保存为pkl文件
